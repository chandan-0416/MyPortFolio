...
import pic from "../../public/chandan.jpg"
function Home() {
  return (
    <>
     ...
     Hi👋
         I am passionate React Developer Frontend web development and proficient in React.js,
         JavaScript, HTML5, CSS3, Tailwind and Version Control System (Git & GitHub). The dynamic
         and fast-paced nature of frontend development has always fascinated me and I am eager 
         to apply my skills and continue learning in a professional setting.
     </p>
     <br/>
     {/* Social Media icons*/ }
